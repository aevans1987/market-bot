...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(result)
        await interaction.reply({content: `Selling ${interaction.options.getString('product')} at ${interaction.options.getNumber('price')} with ${interaction.options.getString('availability') ?? 'no listed' } availability ${result}.`, ephemeral: true })
    },
};